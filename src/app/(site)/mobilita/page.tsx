...
const Mobilita = async () => {
  ...
  try {
    const globalData = (await findGlobals({ slug: 'mobilita' })) as unknown as GlobalTesti
  ...
  return (
    <main className="mx-auto max-w-xl">
      <Navbar backgroundColor="bg-white" currentPage="/mobilita" />
      <div className="bg-white p-3 pt-5">
        <h1 className="font-normal text-3xl pt-4 pb-4 leading-4">Mobilità sostenibile</h1>
        {testoAbout ? (
